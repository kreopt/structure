...
visit(Visitor &&visitor, VariantA &&variantA, Variants &&...variants) {
#ifndef USE_BOOST_VARIANT
...
#else
    return boost::apply_visitor(visitor, variantA);
#endif
}
...
#ifndef USE_BOOST_VARIANT
    return variant_detail::IndexOf<T, Types...>::value == v.which();
#else
...
template <class T, class... Types>
constexpr T& get(bp::variant<Types...>& v) {
#ifndef USE_BOOST_VARIANT
    return v.get<T>();
#else
...
template <class T, class... Types>
constexpr const T& get(const bp::variant<Types...>& v) {
#ifndef USE_BOOST_VARIANT
    return v.get<T>();
#else
    return boost::get<T>(v);
